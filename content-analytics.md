...
Install the skill "Content Analytics" (yang1002378395-cmyk) from ClawHub version 1.0.0only after those checks pass.
Skill page: https://clawhub.ai/yang1002378395-cmyk/content-analytics

About this skill: 分析掘金、小红书、知乎多平台内容表现数据，提供汇总对比和基于AI的优化建议。
