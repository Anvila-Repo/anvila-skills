...
Install the skill "figma-optimizer" (Garvin131) from ClawHub version 1.0.4only after those checks pass.
Skill page: https://clawhub.ai/garvin131/figma-code-optimizer

About this skill: 从Figma设计稿生成符合项目组件库和设计规范的高质量前端代码
